...
static const struct bt_data ad[] = {
  BT_DATA_BYTES(BT_DATA_UUID128_ALL, DONGLE_SERVICE_UUID)
};
#endif
...
BT_GATT_SERVICE_DEFINE(dongle_service,
     ...
     // 1. Interaction Data
     BT_GATT_CHARACTERISTIC(BT_UUID_DECLARE_128(DONGLE_CHARACTERISTIC_UUID),
       BT_GATT_CHRC_NOTIFY | BT_GATT_CHRC_WRITE,
       (BT_GATT_PERM_READ | BT_GATT_PERM_WRITE), NULL, NULL, &state),
     // 2. CCC
